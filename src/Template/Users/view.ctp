        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="iframe-container">
                    <iframe id="<?=h($inboxes->id)?>" data-id="<?=h($inboxes->id)?>" src="" frameborder="0" data-message="<?=h($inboxes->message)?>" ></iframe>
                </td>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?=h($sents->_from)?></td>
                <td class="iframe-container">
                    <iframe id="<?=h($sents->id)?>" data-id="<?=h($sents->id)?>" src="" frameborder="0" data-message="<?=h($sents->message)?>" ></iframe>
                </td>
