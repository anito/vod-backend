    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="actions">
                    <?=$this->Html->link(__('View'), ['controller' => 'Sents', 'action' => 'view', $mails->id])?>
                    <?=$this->Html->link(__('Edit'), ['controller' => 'Sents', 'action' => 'edit', $mails->id])?>
                    <?=$this->Form->postLink(__('Delete'), ['controller' => 'Sents', 'action' => 'delete', $mails->id], ['confirm' => __('Are you sure you want to delete # {0}?', $mails->id)])?>
                </td>
            </tr>
            <?php endforeach;?>
        </table>
