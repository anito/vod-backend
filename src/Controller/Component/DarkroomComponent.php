...
class DarkroomComponent extends Component
{
    ...
    ////
    public function develop($name, $filename, $new_w, $new_h, $quality, $sharpening, $square = false, $x, $y, $force = false)
    {
        //sleep(5);
        $old_mask = umask(0);
        ...
        $ext = $this->File->returnExt($name);
        // Find out what we are dealing with
        switch (true) {
            case preg_match('/jpg|jpeg|jpe/i', $ext):
